...
def generate_all_assets():
  ...
  <g transform="translate(28, 26)">
    ...
    <g transform="translate(0, 102)">
      ...
      <text x="55" y="26" text-anchor="middle" fill="#34D399" font-family="'Inter', sans-serif" font-size="18" font-weight="900">720+</text>
      <text x="55" y="44" text-anchor="middle" fill="#94A3B8" font-family="'Inter', sans-serif" font-size="9" font-weight="600">COMMITS LOGGED</text>

      <!-- Box 2: PRs -->
      <rect x="120" y="0" width="110" height="56" rx="10" fill="#152119" stroke="#1e3226"/>
      <text x="175" y="26" text-anchor="middle" fill="#38bdf8" font-family="'Inter', sans-serif" font-size="18" font-weight="900">34+</text>
      ...
      <text x="295" y="26" text-anchor="middle" fill="#facc15" font-family="'Inter', sans-serif" font-size="18" font-weight="900">A+ RANK</text>
      ...
      <text x="415" y="26" text-anchor="middle" fill="#34D399" font-family="'Inter', sans-serif" font-size="16" font-weight="900">71% TS</text>
  ...
  <g transform="translate(545, 24)">
    ...
    with open('assets/arcade_hud.svg', 'w') as f:
        f.write(arcade_telemetry_svg)
